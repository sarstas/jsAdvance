Vue.component('cart', {
    ...
    methods: {
        ...
        // total(){
        //     return this._cartItems.reduce((sum, item) => sum + item.price, 0);
        // }
    },
    computed: {
        total: () => {
    ...
    template: `
                <div>
                    <button class="btn-cart" type="button" @click="showCart = !showCart">
                        <svg class="header__btn" width="32" height="29" viewBox="0 0 32 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="cart-block" v-show="showCart">
                        <cart-item 
                         ...
                         <div class="cart-box__total-box">
                              ...
                              <p class="cart-box__total"> {{ total }} </p>
                        </div> 
                        <a href="checkout.html" class="cart-box__button">Checkout</a>
                        <a href="shoppingCart.html" class="cart-box__button">Go to cart</a>
                    </div>                 
                </div>
...
Vue.component('cart-item', {
    props: ['img', 'cartItem'],
    data(){
        const cart_img = `${this.img}${this.cartItem.id_product}.png`
        return {
            cart_img
        }
    },
    template: `
        <div class="cart-box__item">
            <div class="product-bio">
                <img :src="this.cart_img" alt="Some img" class="cart-box__img">
